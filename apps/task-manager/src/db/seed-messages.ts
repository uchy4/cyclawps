...
const SEED_MESSAGES: SeedMessage[] = [
  ...
  },
  {
    ...
    senderType: 'user',
    senderName: 'user',
    content: 'Sounds like a plan. @gopher can you pull the latest dependencies and make sure our lock file is clean?',
    taskTitle: null,
    agentRole: null,
    replyTo: null,
    minutesAgo: 170,
  ...
  // ── Thread: Set up CI/CD pipeline ────────────────────────
  {
    ...
    senderType: 'user',
    senderName: 'user',
    content: 'We need a CI/CD pipeline. @gopher can you set up GitHub Actions with build, test, lint stages?',
