  ...
  return (
    <div className={`fixed inset-x-0 bottom-0 ${isElectron ? 'top-[2.5rem]' : 'top-0'} z-50 flex justify-end`}>
      ...
      <div
        ...
        className={`relative w-full max-w-2xl bg-zinc-900 border-l border-zinc-700 shadow-xl flex flex-col ${isClosing ? 'animate-slide-out' : 'animate-slide-in'}`}
        onAnimationEnd={() => {
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-700">
          ...
          <button
            onClick={onClose}
            aria-label="Close"
            className="text-zinc-400 hover:text-white transition-colors p-1 rounded-md hover:bg-zinc-800 focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:outline-none"
          >
